...
rel.importance.trans$Feature2<-fct_relevel(rel.importance.trans$Feature2,
                                           "%Low income HHs",
                                           "%Median income HHs",
                                           "%High income HHs",
                                           "%Social grade C1",
...
rel.importance.trans$Feature2<-factor(rel.importance.trans$Feature2,
                                      levels=c("%Low income HHs",
                                           "%Median income HHs",
                                           "%High income HHs",
                                           "%Social grade C1",
                                           "%more than 3 beds",
